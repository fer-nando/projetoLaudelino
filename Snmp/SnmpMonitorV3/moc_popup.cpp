...
**
** Created: Sat Sep 3 22:29:16 2011
...
static const char qt_meta_stringdata_Popup[] = {
    "Popup\0"
};

const QMetaObject Popup::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Popup,
      qt_meta_data_Popup, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Popup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Popup))
